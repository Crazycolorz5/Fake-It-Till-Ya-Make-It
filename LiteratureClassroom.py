...
def literatureClassroomLookaround(player, locationState):
    ...
    kevinPriceStatus = "Kevin Price is sitting reading a religious text, and not any assigned reading of the class. He seems like he is putting off his work." if not answeredKevinPrice else "Kevin has gone back to reading his Book of Mormon."
